...
### Conclusion
Overall, EfficientNet is the most efficient model for both multi-class and multi-label classification problems. It performs well in all metrics and show stable learning. ViT performs as other algorithms in terms of metrics. However, there are significantly less params to train. That makes this architecture to be alternative for ConvNets in the future.
